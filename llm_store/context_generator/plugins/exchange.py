...
class Yahoo_ExchangePlugin(
    ...
    def _process(self, response: httpx.Response) -> Iterator[str]:
        ...
        if exchange_info:
            ...
            sentence = f'The code of the exchange on which the {{subject}} company trades is {exchange}.'  # noqa: E501
...
class Wikipedia_ExchangePlugin(
    ...
    plugin_patterns=[
        r'.*https?://(ja|ca|en|it|fr|th|ru|nl|fa|he|pt|zh)\.wikipedia\.org/wiki/'  # noqa: E501
    ],
    plugin_priority=101,
):
    ...
    def _extract_exchange(self, text: str, company_name: str) -> str:
        try:
            ...
            exchange_info = text[
                comma_index + 1 : colon_index  # noqa: E203
            ].strip()
