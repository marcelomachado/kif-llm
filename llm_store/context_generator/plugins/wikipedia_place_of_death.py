        ...
        if infobox:
            for row in infobox.find_all('tr'):
                ...
                if header and (
                    ...
                    pattern = re.compile(
                        r"([A-Za-z\s-]+),\s*([A-Za-z\s-]+)(?=\s*,|$)|([A-Za-z\s-]+)\s+([A-Za-z\s-]+)$"  # noqa: E501
                    )
                    ...
                    if death_place and len(death_place) > 0:
                        ...
                        yield (
                            'The city where {{subject}} died is in the '
                            f'following sentence: {death_place}.'
                        )
                        break
                else:
                    if header:
                            ...
                            for death_str in death_list_str:
                                if death_str in header.get_text():
                                    ...
                                    if (
                                        ...
                                        yield f'The city where {{subject}} is in the following sentence (translate from {language_code} to en): {death_date}.'  # noqa: E501
                                        break
                                        ...
                                        if match:
                                            ...
                                            if (
                                                ...
                                                yield f'The city where {{subject}} is in the following sentence (translate from {language_code} to en): {death_place}.'  # noqa: E501
                                                break
                                        else:
                                            pattern = re.compile(
                                                r"\(\d+ рік\)\s*(.*)"
                                        ...
                                        if (
                                            ...
                                            yield f'The city where {{subject}} is in the following sentence: {death_date}.'  # noqa: E501
                                            break
